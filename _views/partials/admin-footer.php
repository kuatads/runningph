    ...
    <script src="<?php echo SITE_URL ?>/assets/libs/flot/jquery.flot.pie.js"></script>
    ...
    <script src="<?php echo SITE_URL ?>/assets/dist/js/pages/chart/chart-page-init.js"></script>
